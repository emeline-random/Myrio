...
class Level02(level.Level):
    def __init__(self, player):
        ...
        level_enemies = [sprites.Cheep(1154, 214, 1647, 1147),
                         ...
                         sprites.Hurchin(2800, 55, 45, 265, True)]
